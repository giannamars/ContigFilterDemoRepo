...
SERVICE_CAPS = giannamarsContigFilterApplicationDemo
SPEC_FILE = giannamarsContigFilterApplicationDemo.spec
URL = https://kbase.us/services/giannamarscontigfilterapplicationdemo
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
