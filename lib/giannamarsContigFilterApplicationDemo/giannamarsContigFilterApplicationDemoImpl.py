...
class giannamarsContigFilterApplicationDemo:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    def run_giannamarsContigFilterApplicationDemo(self, ctx, params):
        """
        ...
        #BEGIN run_giannamarsContigFilterApplicationDemo

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_giannamarsContigFilterApplicationDemo function. Params=' + pformat(params))
        ...
        #END run_giannamarsContigFilterApplicationDemo

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_giannamarsContigFilterApplicationDemo return value ' +
